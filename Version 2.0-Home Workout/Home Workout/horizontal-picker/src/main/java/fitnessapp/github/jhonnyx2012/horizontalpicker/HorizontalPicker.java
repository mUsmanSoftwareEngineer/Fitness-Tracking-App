package fitnessapp.github.jhonnyx2012.horizontalpicker;
...
public class HorizontalPicker extends LinearLayout implements HorizontalPickerListener {
    ...
    public void init() {
        ...
        mDateSelectedColor = mDateSelectedColor == -1 ? getColor(R.color.green_seven_fit) : mDateSelectedColor;
        ...
        mDayOfWeekTextColor = mDayOfWeekTextColor == -1 ? getColor(R.color.green_seven_fit) : mDayOfWeekTextColor;
