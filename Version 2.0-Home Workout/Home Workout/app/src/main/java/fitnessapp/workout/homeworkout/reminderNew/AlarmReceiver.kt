package fitnessapp.workout.homeworkout.reminderNew
...
import fitnessapp.workout.homeworkout.stretching.HomeActivity
...
//        mPendingIntent = PendingIntent.getBroadcast(context, ID, intent, PendingIntent.FLAG_CANCEL_CURRENT)
        mPendingIntent = PendingIntent.getBroadcast(context,
            intent_id, intent, PendingIntent.FLAG_MUTABLE)
//        mPendingIntent = PendingIntent.getBroadcast(context, ID, intent, PendingIntent.FLAG_UPDATE_CURRENT)
    ...
    fun cancelAlarm(context: Context, ID: Int) {
        ...
        mPendingIntent = PendingIntent.getBroadcast(context,
            ID, Intent(context, AlarmReceiver::class.java), 0)
