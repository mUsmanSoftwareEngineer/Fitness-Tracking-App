...
import kotlinx.android.synthetic.main.spinner_sel_item.*
...
//                    Uri.parse("package:" + BuildConfig.APPLICATION_ID)
    ...
    open fun showExcDetailDialog(
        ...
        dialogWorkoutDetailBinding.llEdit.visibility = View.VISIBLE
        dialogWorkoutDetailBinding.llPlusMinus.visibility = View.VISIBLE
        ...
        fun showExcDetail(pos: Int) {
            ...
            dialogWorkoutDetailBinding.imgPlus.setOnClickListener{


//            showToast("plus click")
            second++
            if (item.exUnit.equals(Constant.workout_type_step)) {
                dialogWorkoutDetailBinding.tvTime.text = "X ${second}"
            } else {
                dialogWorkoutDetailBinding.tvTime.text =
                    Utils.secToString(second, Constant.WORKOUT_TIME_FORMAT)
            }
            ...
            dialogWorkoutDetailBinding.imgMinus.setOnClickListener{
//                showToast("plus click")
                second--
                if (item.exUnit.equals(Constant.workout_type_step)) {
                    dialogWorkoutDetailBinding.tvTime.text = "X ${second}"
            ...
            dialogWorkoutDetailBinding.tvSave.setOnClickListener {
...
//                dialogWorkoutDetailBinding.dismiss()
            }

            dialogWorkoutDetailBinding.tvReset.setOnClickListener {
...
//            if (LocalDB.getWeightUnit(mContext) == CommonString.DEF_KG) {
            if (Utils.getPref(this, Constant.PREF_KG_LB_UNIT, Constant.DEF_KG) == Constant.DEF_LB) {
                ...
                tvKG.setTextColor(ContextCompat.getColor(this, R.color.white_seven_fit))
                tvLB.setTextColor(ContextCompat.getColor(this, R.color.white_seven_fit))
...
//            if (LocalDB.getHeightUnit(mContext) == CommonString.DEF_IN) {
            if (Utils.getPref(this, Constant.PREF_IN_CM_UNIT, Constant.DEF_IN) == Constant.DEF_IN) {
                ...
                tvIN.setTextColor(ContextCompat.getColor(this, R.color.white_seven_fit))
                tvCM.setTextColor(ContextCompat.getColor(this, R.color.white_seven_fit))
