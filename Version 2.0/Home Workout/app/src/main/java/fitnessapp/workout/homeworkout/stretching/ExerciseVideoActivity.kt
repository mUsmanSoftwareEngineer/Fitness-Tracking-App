    ...
    private fun initIntentParam() {
        try {
            if (intent.extras != null) {
                ...
                if (intent.extras!!.containsKey("posChange")) {
                    pos = intent.getIntExtra("posChange", -1)
                }
            }
    ...
    private fun init() {
        ...
        binding!!.adView.adListener = object : AdListener() {
            override fun onAdLoaded() {
                super.onAdLoaded()
                if (binding!!.youtubeView.visibility != View.VISIBLE && Utils.isPurchased(this@ExerciseVideoActivity)
                        .not()
                ) {
...
//                binding!!.videoView.setVideoURI(Utils.videoURIList.get(i))
...
//                }
        ...
        Log.d("checkUpdatePos", pos.toString())
        binding!!.videoView.setVideoURI(pos?.let { Utils.videoURIList.get(it) })
        binding!!.videoView.start()
        binding!!.videoView.setOnPreparedListener {
            it.isLooping = true
        }
...
//            binding!!.adView.visibility =View.VISIBLE
    ...
    override fun onInitializationFailure(
        ...
        Log.e(
            "TAG",
            "onInitializationFailure:::Fail Youtuber:::  " + p0.toString() + "  " + p1.toString()
        )
    }
