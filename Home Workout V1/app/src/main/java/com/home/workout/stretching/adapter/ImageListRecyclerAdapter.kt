...
//        }
    ...
    inner class VerticalItemHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var imgImage = itemView.findViewById<AppCompatImageView>(R.id.imgImage)
        var imgSelected = itemView.findViewById<AppCompatImageView>(R.id.imgSelected)
        var container = itemView.findViewById<FrameLayout>(R.id.container)
