...
import com.home.workout.databinding.ActivityHomeBinding
import com.home.workout.stretching.adapter.HomePlansAdapter
import com.home.workout.stretching.adapter.HomeWeekGoalAdapter
...
import com.home.workout.stretching.utils.*
import com.home.workout.stretching.viewmodel.AdsIdData
import java.util.*
...
//        RequestConfiguration.Builder().setTestDeviceIds(listOf("9CC18F110F993FBFD4CDC98B82191F4A"))
    ...
    private fun subScribeToFirebaseTopic() {
        FirebaseMessaging.getInstance().subscribeToTopic("female_stretching_topic")
