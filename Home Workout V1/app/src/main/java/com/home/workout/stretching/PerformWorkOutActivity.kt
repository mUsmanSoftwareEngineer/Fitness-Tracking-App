...
import com.home.workout.databinding.ActivityPerformWorkoutBinding
import com.home.workout.databinding.BottomSheetSoundOptionBinding
import com.home.workout.databinding.DialogQuiteWorkoutBinding
import com.home.workout.stretching.adapter.WorkoutProgressIndicatorAdapter
...
import com.home.workout.stretching.objects.Music
import com.home.workout.stretching.utils.AdUtils
import com.home.workout.stretching.utils.Constant
import com.home.workout.stretching.utils.CountDownTimerWithPause
import com.home.workout.stretching.utils.Debug
import com.home.workout.stretching.utils.MySoundUtil
...
class PerformWorkOutActivity : BaseActivity(), CallbackListener {
    ...
    private fun goToCompleteScreen() {
        ...
        Log.e(TAG, "goToCompleteScreen:::: "+Utils.getPref(this, Constant.STATUS_ENABLE_DISABLE, "")+"  "+
    ...
    fun stopTimer() {
        if (timer != null) {
            timer!!.cancel()
            timer = null
            com.home.workout.stretching.utils.Debug.e(TAG, "OnTimer cancel")
        }
    }
    ...
    fun resumeTimer() {
        if (timer != null && timer!!.isPaused) {
            timer!!.resume()
            com.home.workout.stretching.utils.Debug.e(TAG, "OnTimer resume")
        }
        if (running.not()) {
            running = true
            exStartTime = System.currentTimeMillis()
    ...
    fun pauseTimer() {
        ...
        if (timer != null && timer!!.isRunning) {
            timer!!.pause()
            com.home.workout.stretching.utils.Debug.e(TAG, "OnTimer pause")
        }
    }
...
//        quiteDialog.requestWindowFeature(Window.FEATURE_NO_TITLE)
        ...
        var dialogQuiteWorkoutBinding =
            DataBindingUtil.inflate<DialogQuiteWorkoutBinding>(layoutInflater, R.layout.dialog_quite_workout, null, false)

        quiteDialog.setContentView(dialogQuiteWorkoutBinding.root)

        quiteDialog.window!!.setLayout(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT)
    ...
    public fun quiteData(dialog: Dialog){
        dialog.dismiss()
        saveData()
    }
