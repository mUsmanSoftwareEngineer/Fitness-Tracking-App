...
import com.home.workout.databinding.ActivityCompletedBinding
...
import com.home.workout.stretching.HistoryActivity
import com.home.workout.stretching.PerformWorkOutActivity
import java.util.*
        ...
        fun onKGClick() {
            if (binding!!.tvKG.isSelected.not()) {
                ...
                if (binding!!.editWeight.text.toString() != "") {
                    binding!!.editWeight.setText(Utils.getStringFormat(Utils.lbToKg(binding!!.editWeight.text.toString().toDouble())))
                }
