            ...
            if (Utils.getPref(this, Constant.SPLASH_SCREEN_COUNT, 1) == 1) {
               ...
               checkPermissions(this)
                ...
                Handler(Looper.getMainLooper()).postDelayed({
                    if (!isFinishing && !isDestroyed) { // Ensure Activity is still alive
                        startNextActivity()
                    }
                }, 2000)
//                checkAd()
...
//    }
    ...
    fun startNextActivity(){
        if (Utils.getPref(applicationContext, Constant.PREF_IS_FIRST_TIME, true) &&
            Utils.getPref(applicationContext, Constant.PREF_WHATS_YOUR_GOAL, "").isNullOrEmpty()) {
