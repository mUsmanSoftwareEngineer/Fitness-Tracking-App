package com.home.workout.stretching.db
...
import com.home.workout.stretching.objects.*
...
//                copyDatabase(dbFile)
        ...
        val database = SQLiteDatabase.openDatabase(dbFile.path, null, SQLiteDatabase.OPEN_READWRITE,object : DatabaseErrorHandler{
