...
import com.home.workout.databinding.ItemDaysPlanBinding
        ...
        adapter.setEventListener(object : WeekDaysAdapter.EventListener {
            override fun onItemClick(child: Int, view: View) {
                ...
                if (mEventListener != null) {
                    mEventListener!!.onItemClick(holder.adapterPosition,child, view)
                }

            }

            override fun onSetContinueItemPos(position: Int) {
                continueDataChildPos = position
